      ...
      <ProSidebar collapsed={isCollapsed}>
        <Menu iconShape="square">
          ...
          <Box paddingLeft={isCollapsed ? undefined : "10%"}>
            ...
            {
              userType == "merchant" && <MerchantSidebarItems selected={selected} setSelected={setSelected} />
            }

            {/* Volunteer Sidebar items */}
            {
              userType == "volunteer" && <VolunteerSidebarItems selected={selected} setSelected={setSelected} />
            }
